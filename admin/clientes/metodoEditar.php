<?php
	...
	if($_FILES["imagen"]["name"]!="")
	{
		...
		$resultado = $con->query("UPDATE clientes SET nombre='$nombre', categoria='$categoria', imagen='$ruta' WHERE ID='$ID'");

	}
	else{
		$resultado = $con->query("UPDATE clientes SET nombre='$nombre', categoria='$categoria' WHERE ID='$ID'");
