...
?>
	...
	<div class="page-header">
		<h2 class="text-center">Cobros</h1>
	</div>
	<div class="col-sm-12">
		<div class="col-sm-3">
			<h4>Filtros:</h4>
		...
		<table class="table table-hover">
			...
			<tbody>
				<?php
					...
					$sql="SELECT * FROM cobro WHERE fecha<='$Termino' AND fecha>='$Inicio' ORDER BY fecha ASC";
					...
					for ($i = 0; $i <$result->num_rows; $i++) 
					{
						...
						echo '<tr>
								...
								<td>'. $fila["precio"] .'</td>
								<td>'. $fila["pagado"] .'</td>
								<td><a href="verCobro.php?t='.$ID.'"><span class="glyphicon glyphicon-list-alt text-primary"></span></a></td>
							</tr>';
					}
				?>				
			</tbody>
