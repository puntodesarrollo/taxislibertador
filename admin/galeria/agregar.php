...
?>
	...
	<div class="page-header">
		<h2 class="text-center">Agregar Imagen a Galeria</h2>
	</div>
	<br class="hidden-xs">
	<br class="hidden-xs">
	<div id="contenido">
			...
			<div class="col-xs-12 col-sm-8 col-sm-offset-2">
				<form action="subir.php" method="post" enctype="multipart/form-data">
					...
					<div class="modal-footer">
						<a href="/admin/galeria" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-remove" aria-hidden="true"></i>&nbsp;Cancelar</a>
