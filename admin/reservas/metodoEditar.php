<?php	
	...
	$sql = "UPDATE reservas set fecha='".$d1->format('Y-m-d H:i:s')."',direccion='$direccion', solicitante='$solicitante', comentario='$comentario', telefono='$telefono', correo='$correo'  WHERE ID='$ID'";
