			...
			<div class="col-xs-12 col-sm-10 col-sm-offset-1">
				<form action="metodoEditar.php" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
			                <input class="form-control fecha" id="fecha" name="fecha"
			                       ...
			                       type="text" value="<?php echo $FECHA;?>" required>
                       </div>
	            	</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
			                <input class="form-control hora" id="hora" name="hora"
			                       ...
			                       type="text" value="<?php echo $HORA;?>" required>
                       </div>
	            	</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" name="direccion" id="direccion" type="text" value="<?php echo $direccion;?>" required />
                       </div>						
					</div>
					<div class="form-group">
						<label for="nombre" class="control-label col-sm-2">Comentarios del Servicio</label>
						<div class="col-sm-10">
							<textarea rows="5" name="comentario" id="comentario" class="form-control" placeholder="comentarios sobre el servicio" maxlength="2000" style="width:100% !important" required ><?php echo $comentario;?></textarea>
                       </div>
					</div>
					<div class="form-group">
						<label for="nombre" class="control-label col-sm-2">Solicitante</label>
						<div class="col-sm-10">
							<input class="form-control" name="solicitante" id="solicitante" type="text" value="<?php echo $solicitante;?>" required />
                       </div>
					</div>
					<div class="form-group">
						<label for="nombre" class="control-label col-sm-2">Telefono</label>
						<div class="col-sm-10">
							<input class="form-control" name="telefono" id="telefono" type="text" value="<?php echo $telefono;?>" required />
                       </div>						
					</div>
					<div class="form-group">
						<label for="nombre" class="control-label col-sm-2">Correo</label>
						<div class="col-sm-10">
							<input class="form-control" name="correo" id="correo" type="mail" value="<?php echo $correo;?>" required />
                       </div>
					</div>
					<br />
					<br />
					<div class="modal-footer">
						...
						<button id="botonAgregar" class="btn btn-primary btn-lg"><i class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></i>&nbsp;Editar</button>
					</div>
				</form>
			</div>
		</div>		
